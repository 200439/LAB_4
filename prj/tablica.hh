...
class tablica {
	...
	tablica(const char * name) {nazwa=name, ilosc_pocz=elementy(nazwa), ilosc=ilosc_pocz, tab_1=new int [ilosc], wypelnij();}
	tablica() {nazwa="tablica", ilosc_pocz=elementy(nazwa), ilosc=ilosc_pocz, tab_1=new int [ilosc], wypelnij();}
